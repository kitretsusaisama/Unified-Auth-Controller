use auth_audit::{AuditLog, AuditService};
use chrono::Utc;
use serde_json::json;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let log2 = audit_service
        .log("TEST_ACTION_2", actor_id, "resource_b", None)
        .await?;
    ...
    assert_eq!(
        ...
        "Chain broken: Log 2 prev_hash must match Log 1 hash"
    );
